    ...
    <div className="bg-gray-900 min-h-screen pt-8 flex flex-col md:flex-row justify-items-stretch">
      ...
      <form className="w-[100%] md:w-[50%]">
        <p class="text-white mb-4 text-sm mr-[25%] md:block hidden">
          ...
          sentiments on Singapore&apos;s carparks, anonymously. Enter the area
          you are in, along with the feedback you have for the specific place -
          this will reach HDB officials who will be checking in regularly!
        </p>{" "}
